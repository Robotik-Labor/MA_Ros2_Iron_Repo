...
static const _GetSolution_Event_type_support_symbol_names_t _GetSolution_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moveit_task_constructor_msgs, srv, GetSolution_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, moveit_task_constructor_msgs, srv, GetSolution_Event)),
  }
};
...
{
  return &::moveit_task_constructor_msgs::srv::rosidl_typesupport_cpp::GetSolution_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, moveit_task_constructor_msgs, srv, GetSolution_Event)() {
  return get_message_type_support_handle<moveit_task_constructor_msgs::srv::GetSolution_Event>();
}
...
static const rosidl_service_type_support_t GetSolution_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<moveit_task_constructor_msgs::srv::GetSolution_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<moveit_task_constructor_msgs::srv::GetSolution_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<moveit_task_constructor_msgs::srv::GetSolution_Event>(),
