...
[[deprecated("use moveit_task_constructor_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const moveit_task_constructor_msgs::action::ExecuteTaskSolution_SendGoal_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  moveit_task_constructor_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use moveit_task_constructor_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const moveit_task_constructor_msgs::action::ExecuteTaskSolution_SendGoal_Event & msg)
{
  return moveit_task_constructor_msgs::action::to_yaml(msg);
}
...
[[deprecated("use moveit_task_constructor_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const moveit_task_constructor_msgs::action::ExecuteTaskSolution_GetResult_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  moveit_task_constructor_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use moveit_task_constructor_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const moveit_task_constructor_msgs::action::ExecuteTaskSolution_GetResult_Event & msg)
{
  return moveit_task_constructor_msgs::action::to_yaml(msg);
}
