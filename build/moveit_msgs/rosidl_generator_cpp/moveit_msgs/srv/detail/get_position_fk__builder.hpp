...
class Init_GetPositionFK_Event_response
{
public:
  explicit Init_GetPositionFK_Event_response(::moveit_msgs::srv::GetPositionFK_Event & msg)
  : msg_(msg)
  {}
  ::moveit_msgs::srv::GetPositionFK_Event response(::moveit_msgs::srv::GetPositionFK_Event::_response_type arg)
  {
...
private:
  ::moveit_msgs::srv::GetPositionFK_Event msg_;
};

class Init_GetPositionFK_Event_request
{
public:
  explicit Init_GetPositionFK_Event_request(::moveit_msgs::srv::GetPositionFK_Event & msg)
  : msg_(msg)
  {}
  Init_GetPositionFK_Event_response request(::moveit_msgs::srv::GetPositionFK_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_GetPositionFK_Event_response(msg_);
  }
...
class Init_GetPositionFK_Event_info
{
public:
  Init_GetPositionFK_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetPositionFK_Event_request info(::moveit_msgs::srv::GetPositionFK_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_GetPositionFK_Event_request(msg_);
  }
...
template<>
inline
auto build<::moveit_msgs::srv::GetPositionFK_Event>()
{
  return moveit_msgs::srv::builder::Init_GetPositionFK_Event_info();
}
