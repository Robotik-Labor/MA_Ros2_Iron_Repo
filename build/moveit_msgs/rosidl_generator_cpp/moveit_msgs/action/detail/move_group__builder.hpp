...
class Init_MoveGroup_SendGoal_Event_response
{
public:
  explicit Init_MoveGroup_SendGoal_Event_response(::moveit_msgs::action::MoveGroup_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::moveit_msgs::action::MoveGroup_SendGoal_Event response(::moveit_msgs::action::MoveGroup_SendGoal_Event::_response_type arg)
  {
...
private:
  ::moveit_msgs::action::MoveGroup_SendGoal_Event msg_;
};

class Init_MoveGroup_SendGoal_Event_request
{
public:
  explicit Init_MoveGroup_SendGoal_Event_request(::moveit_msgs::action::MoveGroup_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_MoveGroup_SendGoal_Event_response request(::moveit_msgs::action::MoveGroup_SendGoal_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_MoveGroup_SendGoal_Event_response(msg_);
  }
...
class Init_MoveGroup_SendGoal_Event_info
{
public:
  Init_MoveGroup_SendGoal_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_MoveGroup_SendGoal_Event_request info(::moveit_msgs::action::MoveGroup_SendGoal_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_MoveGroup_SendGoal_Event_request(msg_);
  }
...
template<>
inline
auto build<::moveit_msgs::action::MoveGroup_SendGoal_Event>()
{
  return moveit_msgs::action::builder::Init_MoveGroup_SendGoal_Event_info();
}
...
class Init_MoveGroup_GetResult_Event_response
{
public:
  explicit Init_MoveGroup_GetResult_Event_response(::moveit_msgs::action::MoveGroup_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::moveit_msgs::action::MoveGroup_GetResult_Event response(::moveit_msgs::action::MoveGroup_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::moveit_msgs::action::MoveGroup_GetResult_Event msg_;
};

class Init_MoveGroup_GetResult_Event_request
{
public:
  explicit Init_MoveGroup_GetResult_Event_request(::moveit_msgs::action::MoveGroup_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_MoveGroup_GetResult_Event_response request(::moveit_msgs::action::MoveGroup_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_MoveGroup_GetResult_Event_response(msg_);
  }
...
class Init_MoveGroup_GetResult_Event_info
{
public:
  Init_MoveGroup_GetResult_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_MoveGroup_GetResult_Event_request info(::moveit_msgs::action::MoveGroup_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_MoveGroup_GetResult_Event_request(msg_);
  }
...
template<>
inline
auto build<::moveit_msgs::action::MoveGroup_GetResult_Event>()
{
  return moveit_msgs::action::builder::Init_MoveGroup_GetResult_Event_info();
}
