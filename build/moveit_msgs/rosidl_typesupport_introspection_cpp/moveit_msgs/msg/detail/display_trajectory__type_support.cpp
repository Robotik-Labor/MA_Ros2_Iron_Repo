...
void fetch_function__DisplayTrajectory__trajectory(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const moveit_msgs::msg::RobotTrajectory *>(
    get_const_function__DisplayTrajectory__trajectory(untyped_member, index));
  auto & value = *reinterpret_cast<moveit_msgs::msg::RobotTrajectory *>(untyped_value);
  value = item;
}

void assign_function__DisplayTrajectory__trajectory(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<moveit_msgs::msg::RobotTrajectory *>(
    get_function__DisplayTrajectory__trajectory(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DisplayTrajectory_message_member_array[3] = {
  ...
  },
  {
    ...
    fetch_function__DisplayTrajectory__trajectory,  // fetch(index, &value) function pointer
    assign_function__DisplayTrajectory__trajectory,  // assign(index, value) function pointer
