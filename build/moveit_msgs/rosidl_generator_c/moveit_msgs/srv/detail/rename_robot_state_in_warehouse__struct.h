...
enum
{
  moveit_msgs__srv__RenameRobotStateInWarehouse_Event__request__MAX_SIZE = 1
};
// response
enum
{
  moveit_msgs__srv__RenameRobotStateInWarehouse_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/RenameRobotStateInWarehouse in the package moveit_msgs.
typedef struct moveit_msgs__srv__RenameRobotStateInWarehouse_Event
{
  service_msgs__msg__ServiceEventInfo info;
  moveit_msgs__srv__RenameRobotStateInWarehouse_Request__Sequence request;
  moveit_msgs__srv__RenameRobotStateInWarehouse_Response__Sequence response;
} moveit_msgs__srv__RenameRobotStateInWarehouse_Event;

// Struct for a sequence of moveit_msgs__srv__RenameRobotStateInWarehouse_Event.
typedef struct moveit_msgs__srv__RenameRobotStateInWarehouse_Event__Sequence
{
