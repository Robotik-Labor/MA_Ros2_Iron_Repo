...
#ifndef MOVEIT_MSGS__SRV__DETAIL__SET_PLANNER_PARAMS__FUNCTIONS_H_
#define MOVEIT_MSGS__SRV__DETAIL__SET_PLANNER_PARAMS__FUNCTIONS_H_
...
/// Initialize srv/SetPlannerParams message.
/**
...
/// Finalize srv/SetPlannerParams message.
/**
...
/// Create srv/SetPlannerParams message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * moveit_msgs__srv__SetPlannerParams_Request__init().
...
/// Destroy srv/SetPlannerParams message.
/**
 * It calls
 * moveit_msgs__srv__SetPlannerParams_Request__fini()
...
/// Check for srv/SetPlannerParams message equality.
/**
...
/// Copy a srv/SetPlannerParams message.
/**
...
/// Initialize array of srv/SetPlannerParams messages.
/**
...
/// Finalize array of srv/SetPlannerParams messages.
/**
 * It calls
 * moveit_msgs__srv__SetPlannerParams_Request__fini()
...
/// Create array of srv/SetPlannerParams messages.
/**
...
/// Destroy array of srv/SetPlannerParams messages.
/**
 * It calls
 * moveit_msgs__srv__SetPlannerParams_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetPlannerParams message array equality.
/**
...
/// Copy an array of srv/SetPlannerParams messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * moveit_msgs__srv__SetPlannerParams_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_moveit_msgs
...
/**
 * It calls
 * moveit_msgs__srv__SetPlannerParams_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_moveit_msgs
...
/**
 * It calls
 * moveit_msgs__srv__SetPlannerParams_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * moveit_msgs__srv__SetPlannerParams_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_moveit_msgs
...
/**
 * It calls
 * moveit_msgs__srv__SetPlannerParams_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_moveit_msgs
...
/**
 * It allocates the memory for the array and calls
 * moveit_msgs__srv__SetPlannerParams_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_moveit_msgs
...
/**
 * It calls
 * moveit_msgs__srv__SetPlannerParams_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MOVEIT_MSGS__SRV__DETAIL__SET_PLANNER_PARAMS__FUNCTIONS_H_
