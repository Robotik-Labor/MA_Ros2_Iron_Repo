...
#ifndef MOVEIT_MSGS__SRV__DETAIL__APPLY_PLANNING_SCENE__FUNCTIONS_H_
#define MOVEIT_MSGS__SRV__DETAIL__APPLY_PLANNING_SCENE__FUNCTIONS_H_
...
/// Initialize srv/ApplyPlanningScene message.
/**
...
/// Finalize srv/ApplyPlanningScene message.
/**
...
/// Create srv/ApplyPlanningScene message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * moveit_msgs__srv__ApplyPlanningScene_Request__init().
...
/// Destroy srv/ApplyPlanningScene message.
/**
 * It calls
 * moveit_msgs__srv__ApplyPlanningScene_Request__fini()
...
/// Check for srv/ApplyPlanningScene message equality.
/**
...
/// Copy a srv/ApplyPlanningScene message.
/**
...
/// Initialize array of srv/ApplyPlanningScene messages.
/**
...
/// Finalize array of srv/ApplyPlanningScene messages.
/**
 * It calls
 * moveit_msgs__srv__ApplyPlanningScene_Request__fini()
...
/// Create array of srv/ApplyPlanningScene messages.
/**
...
/// Destroy array of srv/ApplyPlanningScene messages.
/**
 * It calls
 * moveit_msgs__srv__ApplyPlanningScene_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ApplyPlanningScene message array equality.
/**
...
/// Copy an array of srv/ApplyPlanningScene messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * moveit_msgs__srv__ApplyPlanningScene_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_moveit_msgs
...
/**
 * It calls
 * moveit_msgs__srv__ApplyPlanningScene_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_moveit_msgs
...
/**
 * It calls
 * moveit_msgs__srv__ApplyPlanningScene_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * moveit_msgs__srv__ApplyPlanningScene_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_moveit_msgs
...
/**
 * It calls
 * moveit_msgs__srv__ApplyPlanningScene_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_moveit_msgs
...
/**
 * It allocates the memory for the array and calls
 * moveit_msgs__srv__ApplyPlanningScene_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_moveit_msgs
...
/**
 * It calls
 * moveit_msgs__srv__ApplyPlanningScene_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MOVEIT_MSGS__SRV__DETAIL__APPLY_PLANNING_SCENE__FUNCTIONS_H_
