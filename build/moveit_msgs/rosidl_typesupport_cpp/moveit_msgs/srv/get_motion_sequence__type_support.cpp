...
static const _GetMotionSequence_Event_type_support_symbol_names_t _GetMotionSequence_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moveit_msgs, srv, GetMotionSequence_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, moveit_msgs, srv, GetMotionSequence_Event)),
  }
};
...
{
  return &::moveit_msgs::srv::rosidl_typesupport_cpp::GetMotionSequence_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, moveit_msgs, srv, GetMotionSequence_Event)() {
  return get_message_type_support_handle<moveit_msgs::srv::GetMotionSequence_Event>();
}
...
static const rosidl_service_type_support_t GetMotionSequence_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<moveit_msgs::srv::GetMotionSequence_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<moveit_msgs::srv::GetMotionSequence_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<moveit_msgs::srv::GetMotionSequence_Event>(),
