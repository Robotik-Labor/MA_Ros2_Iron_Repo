...
void moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__ListRobotStatesInWarehouse_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  moveit_msgs__srv__ListRobotStatesInWarehouse_Event__init(message_memory);
}

void moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__ListRobotStatesInWarehouse_Event_fini_function(void * message_memory)
{
  moveit_msgs__srv__ListRobotStatesInWarehouse_Event__fini(message_memory);
}

size_t moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__size_function__ListRobotStatesInWarehouse_Event__request(
  const void * untyped_member)
{
  const moveit_msgs__srv__ListRobotStatesInWarehouse_Request__Sequence * member =
    (const moveit_msgs__srv__ListRobotStatesInWarehouse_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__get_const_function__ListRobotStatesInWarehouse_Event__request(
  const void * untyped_member, size_t index)
{
  const moveit_msgs__srv__ListRobotStatesInWarehouse_Request__Sequence * member =
    (const moveit_msgs__srv__ListRobotStatesInWarehouse_Request__Sequence *)(untyped_member);
...
void * moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__get_function__ListRobotStatesInWarehouse_Event__request(
  void * untyped_member, size_t index)
{
  moveit_msgs__srv__ListRobotStatesInWarehouse_Request__Sequence * member =
    (moveit_msgs__srv__ListRobotStatesInWarehouse_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__fetch_function__ListRobotStatesInWarehouse_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const moveit_msgs__srv__ListRobotStatesInWarehouse_Request * item =
    ((const moveit_msgs__srv__ListRobotStatesInWarehouse_Request *)
    moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__get_const_function__ListRobotStatesInWarehouse_Event__request(untyped_member, index));
  moveit_msgs__srv__ListRobotStatesInWarehouse_Request * value =
    (moveit_msgs__srv__ListRobotStatesInWarehouse_Request *)(untyped_value);
  *value = *item;
}

void moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__assign_function__ListRobotStatesInWarehouse_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  moveit_msgs__srv__ListRobotStatesInWarehouse_Request * item =
    ((moveit_msgs__srv__ListRobotStatesInWarehouse_Request *)
    moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__get_function__ListRobotStatesInWarehouse_Event__request(untyped_member, index));
  const moveit_msgs__srv__ListRobotStatesInWarehouse_Request * value =
    (const moveit_msgs__srv__ListRobotStatesInWarehouse_Request *)(untyped_value);
  *item = *value;
}

bool moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__resize_function__ListRobotStatesInWarehouse_Event__request(
  void * untyped_member, size_t size)
{
  moveit_msgs__srv__ListRobotStatesInWarehouse_Request__Sequence * member =
    (moveit_msgs__srv__ListRobotStatesInWarehouse_Request__Sequence *)(untyped_member);
  moveit_msgs__srv__ListRobotStatesInWarehouse_Request__Sequence__fini(member);
  return moveit_msgs__srv__ListRobotStatesInWarehouse_Request__Sequence__init(member, size);
}

size_t moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__size_function__ListRobotStatesInWarehouse_Event__response(
  const void * untyped_member)
{
  const moveit_msgs__srv__ListRobotStatesInWarehouse_Response__Sequence * member =
    (const moveit_msgs__srv__ListRobotStatesInWarehouse_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__get_const_function__ListRobotStatesInWarehouse_Event__response(
  const void * untyped_member, size_t index)
{
  const moveit_msgs__srv__ListRobotStatesInWarehouse_Response__Sequence * member =
    (const moveit_msgs__srv__ListRobotStatesInWarehouse_Response__Sequence *)(untyped_member);
...
void * moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__get_function__ListRobotStatesInWarehouse_Event__response(
  void * untyped_member, size_t index)
{
  moveit_msgs__srv__ListRobotStatesInWarehouse_Response__Sequence * member =
    (moveit_msgs__srv__ListRobotStatesInWarehouse_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__fetch_function__ListRobotStatesInWarehouse_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const moveit_msgs__srv__ListRobotStatesInWarehouse_Response * item =
    ((const moveit_msgs__srv__ListRobotStatesInWarehouse_Response *)
    moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__get_const_function__ListRobotStatesInWarehouse_Event__response(untyped_member, index));
  moveit_msgs__srv__ListRobotStatesInWarehouse_Response * value =
    (moveit_msgs__srv__ListRobotStatesInWarehouse_Response *)(untyped_value);
  *value = *item;
}

void moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__assign_function__ListRobotStatesInWarehouse_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  moveit_msgs__srv__ListRobotStatesInWarehouse_Response * item =
    ((moveit_msgs__srv__ListRobotStatesInWarehouse_Response *)
    moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__get_function__ListRobotStatesInWarehouse_Event__response(untyped_member, index));
  const moveit_msgs__srv__ListRobotStatesInWarehouse_Response * value =
    (const moveit_msgs__srv__ListRobotStatesInWarehouse_Response *)(untyped_value);
  *item = *value;
}

bool moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__resize_function__ListRobotStatesInWarehouse_Event__response(
  void * untyped_member, size_t size)
{
  moveit_msgs__srv__ListRobotStatesInWarehouse_Response__Sequence * member =
    (moveit_msgs__srv__ListRobotStatesInWarehouse_Response__Sequence *)(untyped_member);
  moveit_msgs__srv__ListRobotStatesInWarehouse_Response__Sequence__fini(member);
  return moveit_msgs__srv__ListRobotStatesInWarehouse_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__ListRobotStatesInWarehouse_Event_message_member_array[3] = {
  {
    "info",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(moveit_msgs__srv__ListRobotStatesInWarehouse_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(moveit_msgs__srv__ListRobotStatesInWarehouse_Event, request),  // bytes offset in struct
    NULL,  // default value
    moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__size_function__ListRobotStatesInWarehouse_Event__request,  // size() function pointer
    moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__get_const_function__ListRobotStatesInWarehouse_Event__request,  // get_const(index) function pointer
    moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__get_function__ListRobotStatesInWarehouse_Event__request,  // get(index) function pointer
    moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__fetch_function__ListRobotStatesInWarehouse_Event__request,  // fetch(index, &value) function pointer
    moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__assign_function__ListRobotStatesInWarehouse_Event__request,  // assign(index, value) function pointer
    moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__resize_function__ListRobotStatesInWarehouse_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(moveit_msgs__srv__ListRobotStatesInWarehouse_Event, response),  // bytes offset in struct
    NULL,  // default value
    moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__size_function__ListRobotStatesInWarehouse_Event__response,  // size() function pointer
    moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__get_const_function__ListRobotStatesInWarehouse_Event__response,  // get_const(index) function pointer
    moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__get_function__ListRobotStatesInWarehouse_Event__response,  // get(index) function pointer
    moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__fetch_function__ListRobotStatesInWarehouse_Event__response,  // fetch(index, &value) function pointer
    moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__assign_function__ListRobotStatesInWarehouse_Event__response,  // assign(index, value) function pointer
    moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__resize_function__ListRobotStatesInWarehouse_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__ListRobotStatesInWarehouse_Event_message_members = {
  "moveit_msgs__srv",  // message namespace
  "ListRobotStatesInWarehouse_Event",  // message name
  3,  // number of fields
  sizeof(moveit_msgs__srv__ListRobotStatesInWarehouse_Event),
  moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__ListRobotStatesInWarehouse_Event_message_member_array,  // message members
  moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__ListRobotStatesInWarehouse_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__ListRobotStatesInWarehouse_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__ListRobotStatesInWarehouse_Event_message_type_support_handle = {
  0,
  &moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__ListRobotStatesInWarehouse_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_moveit_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, srv, ListRobotStatesInWarehouse_Event)() {
  moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__ListRobotStatesInWarehouse_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__ListRobotStatesInWarehouse_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, srv, ListRobotStatesInWarehouse_Request)();
  moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__ListRobotStatesInWarehouse_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, srv, ListRobotStatesInWarehouse_Response)();
  if (!moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__ListRobotStatesInWarehouse_Event_message_type_support_handle.typesupport_identifier) {
    moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__ListRobotStatesInWarehouse_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__ListRobotStatesInWarehouse_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t moveit_msgs__srv__detail__list_robot_states_in_warehouse__rosidl_typesupport_introspection_c__ListRobotStatesInWarehouse_service_type_support_handle = {
  ...
  &moveit_msgs__srv__ListRobotStatesInWarehouse_Request__rosidl_typesupport_introspection_c__ListRobotStatesInWarehouse_Request_message_type_support_handle,
  &moveit_msgs__srv__ListRobotStatesInWarehouse_Response__rosidl_typesupport_introspection_c__ListRobotStatesInWarehouse_Response_message_type_support_handle,
  &moveit_msgs__srv__ListRobotStatesInWarehouse_Event__rosidl_typesupport_introspection_c__ListRobotStatesInWarehouse_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, srv, ListRobotStatesInWarehouse)() {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, srv, ListRobotStatesInWarehouse_Event)()->data;
  }
