...
enum
{
  moveit_msgs__srv__GetPlannerParams_Event__request__MAX_SIZE = 1
};
// response
enum
{
  moveit_msgs__srv__GetPlannerParams_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetPlannerParams in the package moveit_msgs.
typedef struct moveit_msgs__srv__GetPlannerParams_Event
{
  service_msgs__msg__ServiceEventInfo info;
  moveit_msgs__srv__GetPlannerParams_Request__Sequence request;
  moveit_msgs__srv__GetPlannerParams_Response__Sequence response;
} moveit_msgs__srv__GetPlannerParams_Event;

// Struct for a sequence of moveit_msgs__srv__GetPlannerParams_Event.
typedef struct moveit_msgs__srv__GetPlannerParams_Event__Sequence
{
