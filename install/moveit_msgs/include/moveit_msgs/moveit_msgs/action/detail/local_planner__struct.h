...
enum
{
  moveit_msgs__action__LocalPlanner_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  moveit_msgs__action__LocalPlanner_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/LocalPlanner in the package moveit_msgs.
typedef struct moveit_msgs__action__LocalPlanner_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  moveit_msgs__action__LocalPlanner_SendGoal_Request__Sequence request;
  moveit_msgs__action__LocalPlanner_SendGoal_Response__Sequence response;
} moveit_msgs__action__LocalPlanner_SendGoal_Event;

// Struct for a sequence of moveit_msgs__action__LocalPlanner_SendGoal_Event.
typedef struct moveit_msgs__action__LocalPlanner_SendGoal_Event__Sequence
{
...
enum
{
  moveit_msgs__action__LocalPlanner_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  moveit_msgs__action__LocalPlanner_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/LocalPlanner in the package moveit_msgs.
typedef struct moveit_msgs__action__LocalPlanner_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  moveit_msgs__action__LocalPlanner_GetResult_Request__Sequence request;
  moveit_msgs__action__LocalPlanner_GetResult_Response__Sequence response;
} moveit_msgs__action__LocalPlanner_GetResult_Event;

// Struct for a sequence of moveit_msgs__action__LocalPlanner_GetResult_Event.
typedef struct moveit_msgs__action__LocalPlanner_GetResult_Event__Sequence
{
