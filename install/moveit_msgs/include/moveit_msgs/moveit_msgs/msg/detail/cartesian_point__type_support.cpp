...
{
  new (message_memory) moveit_msgs::msg::CartesianPoint(_init);
}

void CartesianPoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<moveit_msgs::msg::CartesianPoint *>(message_memory);
  typed_message->~CartesianPoint();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember CartesianPoint_message_member_array[3] = {
  {
    "pose",  // name
    ...
    offsetof(moveit_msgs::msg::CartesianPoint, pose),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(moveit_msgs::msg::CartesianPoint, velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(moveit_msgs::msg::CartesianPoint, acceleration),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CartesianPoint_message_members = {
  ...
  3,  // number of fields
  sizeof(moveit_msgs::msg::CartesianPoint),
...
{
  return &::moveit_msgs::msg::rosidl_typesupport_introspection_cpp::CartesianPoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, moveit_msgs, msg, CartesianPoint)() {
  return &::moveit_msgs::msg::rosidl_typesupport_introspection_cpp::CartesianPoint_message_type_support_handle;
}
