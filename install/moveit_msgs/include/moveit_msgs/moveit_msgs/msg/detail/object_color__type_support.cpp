...
{
  new (message_memory) moveit_msgs::msg::ObjectColor(_init);
}

void ObjectColor_fini_function(void * message_memory)
{
  auto typed_message = static_cast<moveit_msgs::msg::ObjectColor *>(message_memory);
  typed_message->~ObjectColor();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember ObjectColor_message_member_array[2] = {
  {
    "id",  // name
    ...
    offsetof(moveit_msgs::msg::ObjectColor, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(moveit_msgs::msg::ObjectColor, color),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObjectColor_message_members = {
  ...
  2,  // number of fields
  sizeof(moveit_msgs::msg::ObjectColor),
...
{
  return &::moveit_msgs::msg::rosidl_typesupport_introspection_cpp::ObjectColor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, moveit_msgs, msg, ObjectColor)() {
  return &::moveit_msgs::msg::rosidl_typesupport_introspection_cpp::ObjectColor_message_type_support_handle;
}
