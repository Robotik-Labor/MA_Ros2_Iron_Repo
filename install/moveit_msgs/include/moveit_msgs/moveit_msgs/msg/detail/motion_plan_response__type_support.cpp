...
void MotionPlanResponse_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) moveit_msgs::msg::MotionPlanResponse(_init);
}

void MotionPlanResponse_fini_function(void * message_memory)
{
  auto typed_message = static_cast<moveit_msgs::msg::MotionPlanResponse *>(message_memory);
  typed_message->~MotionPlanResponse();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MotionPlanResponse_message_members = {
  ...
  MotionPlanResponse_init_function,  // function to initialize message memory (memory has to be allocated)
  MotionPlanResponse_fini_function  // function to terminate message instance (will not free memory)
};
