...
void OrientedBoundingBox_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) moveit_msgs::msg::OrientedBoundingBox(_init);
}

void OrientedBoundingBox_fini_function(void * message_memory)
{
  auto typed_message = static_cast<moveit_msgs::msg::OrientedBoundingBox *>(message_memory);
  typed_message->~OrientedBoundingBox();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers OrientedBoundingBox_message_members = {
  ...
  OrientedBoundingBox_init_function,  // function to initialize message memory (memory has to be allocated)
  OrientedBoundingBox_fini_function  // function to terminate message instance (will not free memory)
};
