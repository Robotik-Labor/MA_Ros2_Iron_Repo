...
#ifndef COMMON_SERVICES_PACKAGE__SRV__DETAIL__GET_POINT_CLOUD2__FUNCTIONS_H_
#define COMMON_SERVICES_PACKAGE__SRV__DETAIL__GET_POINT_CLOUD2__FUNCTIONS_H_
...
/// Initialize srv/GetPointCloud2 message.
/**
...
/// Finalize srv/GetPointCloud2 message.
/**
...
/// Create srv/GetPointCloud2 message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * common_services_package__srv__GetPointCloud2_Request__init().
...
/// Destroy srv/GetPointCloud2 message.
/**
 * It calls
 * common_services_package__srv__GetPointCloud2_Request__fini()
...
/// Check for srv/GetPointCloud2 message equality.
/**
...
/// Copy a srv/GetPointCloud2 message.
/**
...
/// Initialize array of srv/GetPointCloud2 messages.
/**
...
/// Finalize array of srv/GetPointCloud2 messages.
/**
 * It calls
 * common_services_package__srv__GetPointCloud2_Request__fini()
...
/// Create array of srv/GetPointCloud2 messages.
/**
 * It allocates the memory for the array and calls
 * common_services_package__srv__GetPointCloud2_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetPointCloud2 messages.
/**
 * It calls
 * common_services_package__srv__GetPointCloud2_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetPointCloud2 message array equality.
/**
...
/// Copy an array of srv/GetPointCloud2 messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * common_services_package__srv__GetPointCloud2_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_common_services_package
...
/**
 * It calls
 * common_services_package__srv__GetPointCloud2_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_common_services_package
...
/**
 * It allocates the memory for the array and calls
 * common_services_package__srv__GetPointCloud2_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_common_services_package
...
/**
 * It calls
 * common_services_package__srv__GetPointCloud2_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * common_services_package__srv__GetPointCloud2_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_common_services_package
...
/**
 * It calls
 * common_services_package__srv__GetPointCloud2_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_common_services_package
...
/**
 * It allocates the memory for the array and calls
 * common_services_package__srv__GetPointCloud2_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_common_services_package
...
/**
 * It calls
 * common_services_package__srv__GetPointCloud2_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // COMMON_SERVICES_PACKAGE__SRV__DETAIL__GET_POINT_CLOUD2__FUNCTIONS_H_
