...
#ifndef COMMON_SERVICES_PACKAGE__SRV__DETAIL__GET_PLANTPOT_COORDS__FUNCTIONS_H_
#define COMMON_SERVICES_PACKAGE__SRV__DETAIL__GET_PLANTPOT_COORDS__FUNCTIONS_H_
...
/// Initialize srv/GetPlantpotCoords message.
/**
...
/// Finalize srv/GetPlantpotCoords message.
/**
...
/// Create srv/GetPlantpotCoords message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * common_services_package__srv__GetPlantpotCoords_Request__init().
...
/// Destroy srv/GetPlantpotCoords message.
/**
 * It calls
 * common_services_package__srv__GetPlantpotCoords_Request__fini()
...
/// Check for srv/GetPlantpotCoords message equality.
/**
...
/// Copy a srv/GetPlantpotCoords message.
/**
...
/// Initialize array of srv/GetPlantpotCoords messages.
/**
...
/// Finalize array of srv/GetPlantpotCoords messages.
/**
 * It calls
 * common_services_package__srv__GetPlantpotCoords_Request__fini()
...
/// Create array of srv/GetPlantpotCoords messages.
/**
...
/// Destroy array of srv/GetPlantpotCoords messages.
/**
 * It calls
 * common_services_package__srv__GetPlantpotCoords_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetPlantpotCoords message array equality.
/**
...
/// Copy an array of srv/GetPlantpotCoords messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * common_services_package__srv__GetPlantpotCoords_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_common_services_package
...
/**
 * It calls
 * common_services_package__srv__GetPlantpotCoords_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_common_services_package
...
/**
 * It calls
 * common_services_package__srv__GetPlantpotCoords_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * common_services_package__srv__GetPlantpotCoords_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_common_services_package
...
/**
 * It calls
 * common_services_package__srv__GetPlantpotCoords_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_common_services_package
...
/**
 * It allocates the memory for the array and calls
 * common_services_package__srv__GetPlantpotCoords_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_common_services_package
...
/**
 * It calls
 * common_services_package__srv__GetPlantpotCoords_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // COMMON_SERVICES_PACKAGE__SRV__DETAIL__GET_PLANTPOT_COORDS__FUNCTIONS_H_
